from classifier_solved import load_data,tokenize, data_processor
from classifier_solved import custom_feature_extractor, classifier_agent
from classifier_solved import compute_twogram, custom_feature_extractor2
from classifier_solved import tf_idf, custom_feature_extractor
...
def main():
    ...
    custom_classifier.train_sgd(Xtrain, ytrain, nepoch,12.5, RAW_TEXT = False)
